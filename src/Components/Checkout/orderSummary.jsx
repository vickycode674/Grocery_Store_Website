...
const orderSummary = () => {
  ...
  return (
    <div style={{ position: 'absolute', top: '52%', right: '240px', transform: 'translateY(-50%)', zIndex: '9999' }}>
        <div className="items-start border bg-gray-800 flex max-w-[424px] flex-col p-6 rounded-lg border-solid border-neutral-600" style={{backgroundColor:theme?'#2A2C38':'white'}}>
      ...
      <div className="justify-between items-stretch bg-gray-800 self-stretch flex gap-5 mt-3 py-3" style={{backgroundColor:theme?'#2A2C38':'white'}}>
      ...
      <div className="justify-between items-stretch bg-gray-800 self-stretch flex gap-5 py-3"style={{backgroundColor:theme?'#2A2C38':'white'}}>
      ...
      <div className="bg-neutral-600 self-stretch shrink-0 h-px" />
      <div className="justify-between items-stretch bg-gray-800 self-stretch flex gap-5 pt-3"style={{backgroundColor:theme?'#2A2C38':'white'}}>
        <div className="text-zinc-400 text-base leading-6"style={{color:theme?'white':'black'}}>Total:</div>
        <div className="text-white text-lg font-semibold leading-5 self-start"style={{color:theme?'white':'black'}}>
          $84.00
        </div>
      </div>
