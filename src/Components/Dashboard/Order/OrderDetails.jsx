...
const OrderDetails = () => {
  ...
  return (
    <div className="md:flex font-poppins justify-center">
      <div>
        <NavigationBox />
      </div>
      <div className="border-2 rounded-lg m-2 md:m-0">
        <div>
          ...
          <div className="md:flex">
            ...
            <div className=" border-2 rounded-lg mt-6 md:mr-6 h-[250px] m-2 md:m-0">
              ...
              <div>
                <div className="flex justify-between border-b-2 m-2 p-2">
                  <p className="text-[#666666] text-sm">Subtotal:</p>
                  <p className="font-medium text-sm">$361.50</p>
                </div>
                <div className="flex justify-between border-b-2 m-2 p-2">
                  <p className="text-[#666666] text-sm">Discount:</p>
                  <p className="font-medium text-sm">20%</p>
                </div>
                <div className="flex justify-between border-b-2 m-2 p-2">
                  <p className="text-[#666666] text-sm">Shipping:</p>
          ...
          <div className="flex justify-evenly ml-8 mt-6 md:w-[800px]">
            {steps?.map((step, id) => (
              <div
                key={id}
              ...
              >
                ...
                <p className="text-[#333333] text-sm">{step}</p>
              </div>
            ))}
          </div>
        </div>
