...
import {
 ...
 import { BiShoppingBag ,BiSun, BiMoon} from "react-icons/bi";
...
<div className="container mx-auto flex flex-wrap items-center space-x-44 text-blue-gray-900">
        ...
        <div className="hidden items-center  lg:flex">
          ...
          <Button size="md" className="rounded-lg " style={{ backgroundColor: "#FF5400", }}>
            Search
          </Button>
         
        <div className="px-16 " >
        <Button variant="text" style={{fontSize:'14px',color:darkMode?'white':'black'}}>SignIn/SignUp</Button>
        </div>
        <div className="cursor-pointer">
        <FaRegHeart className="size-8" style={{color:darkMode?'white':'black'}} />
        </div>
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            ...
            <Button size="md" className="mt-1 rounded-lg sm:mt-0" style={{backgroundColor:'#FF6316'}}>
              Search
            </Button>
            <div className="px-16 cursor-pointer">
        <FaRegHeart />
        <BiShoppingBag  />
        </div>
          </div>
